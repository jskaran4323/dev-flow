...
public class IssueController {
  ...
  public ResponseEntity<IssueResponse> createEntity(
      @PathVariable UUID projectId, @RequestBody IssueRequest request, Authentication auth) {
  ...
  public ResponseEntity<List<IssueResponse>> getProjectIssue(
    ...
    List<IssueResponse> response = issues.stream().map(IssueMapper::toIssueResponse).toList();
    return ResponseEntity.ok(response);
  }

  @GetMapping("/{issueId}")
  public ResponseEntity<IssueResponse> getSingleIssue(
      @PathVariable UUID issueId, Authentication auth) {
    return issueService
  ...
  public ResponseEntity<IssueResponse> updateIssue(
      @PathVariable UUID issueId, @RequestBody IssueRequest request, Authentication auth) {
    return issueService
        .getIssueById(issueId)
        .map(
            existing -> {
