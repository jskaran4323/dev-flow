...
public class ProjectController {
  ...
  public ResponseEntity<List<ProjectResponse>> getAllProjects() {
    ...
    List<ProjectResponse> response =
        allProjects.stream().map(ProjectMapper::toResponse).collect(Collectors.toList());
  ...
  public ResponseEntity<ProjectResponse> createProject(
      @RequestBody Project project, Authentication auth) {
  ...
  public ResponseEntity<List<ProjectResponse>> getUserProjects(Authentication auth) {
    ...
    List<ProjectResponse> response =
        projects.stream().map(ProjectMapper::toResponse).collect(Collectors.toList());
